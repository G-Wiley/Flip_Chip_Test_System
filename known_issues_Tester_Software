...
<li>The "set test delay", main menu command "2", has not been verified on the ESP32 code.</li>
<li>The "set test trigger", main menu command "3", has not been verified on the ESP32 code.</li>
<li>The "output loading test", main menu command "58", has not been verified on the ESP32 code.</li>
<li>The "set test delay", main menu command "2", has not been verified on the ESP32 code.</li>
